...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <div class="layui-container">
        	<blockquote class="layui-elem-quote" style="margin-top: 15px;">Teacher List
				<!-- <a href="teachers_add.php" style="margin-left: 30px;" class="layui-btn">Add Teacher</a> -->
        	</blockquote>
			...
			<table class="layui-table">
			  ...
			  <tbody>
				...
				//Total number of queries
					...
					$offset = ($page - 1) * $size;
					// sql query statement
					$sql = "select * from teachers order by id asc limit $offset,$size";
				...
				<tr align="center">
					...
					<td>
						<a class="layui-btn layui-btn-sm" href="teachers_edit.php?id=<?php echo $value['id']; ?>">Edit<i class="layui-icon">&#xe642;</i></a>
						<a class="layui-btn layui-btn-primary layui-btn-sm" onclick="return confirm('Confirm Delete？');" href="teachers_del.php?id=<?php echo $value['id']; ?>">Delete<i class="layui-icon">&#xe640;</i></a>
					</td>
				</tr>
				<?php
					// loop end
				...
				<tr>
					<td colspan="6">
						<a href="teachers.php?page=<?php echo 1?>">Home Page</a>&nbsp;&nbsp;
					    <a href="teachers.php?page=<?php echo $prev_page?>">Prev Page</a>&nbsp;&nbsp;
					    <a href="teachers.php?page=<?php echo $next_page?>">Next Page</a>&nbsp;&nbsp;
					    <a href="teachers.php?page=<?php echo $last?>">End Page</a>&nbsp;&nbsp;
					</td>
				</tr>
			  </tbody>
			</table>
