...
if ($_POST) {
    ...
    if(strtolower($code)==strtolower($_SESSION['captcha_code'])){  //Judge the CAPTCHA first
        // sql query statement
    ...
    if ($row) {
        // 登Record success, deposit user account into session
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Exam Booking System Teacher Login</title>
    ...
    <body style="background-image: url(../img/3.jpg);background-repeat: no-repeat;background-size: 100%;width:100%;height: 100%;overflow-y:hidden;">
    	<form class="layui-form" action="login.php" method="post">
    		<div class="container"style="width: 450px;margin: 170px auto;border: 1px  solid;border-radius:20px; background-color:rgba(255,255,255,0.8);">
    			<div class="layui-form-mid layui-word-aux" style="text-align: center;width: 100%;margin-top: 25px;">
    				<p style="display: block;font-size: 24px;text-align: center;margin-bottom: 30px;width: 100%;font-family: 'Microsoft Yahei';color: #757575;">Exam Booking System<span> Teacher Login</span></p>
    			</div>
			  <div class="layui-form-item">
			    <label class="layui-form-label">Account</label>
			    <div class="layui-input-block">
			      <input type="text" name="tid" required placeholder="Input Account" autocomplete="off" class="layui-input">
			    </div>
			  </div>
			  <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div>
                ...
                <img src="../student/code.php" alt="" id="code_img">
