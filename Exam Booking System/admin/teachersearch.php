...
<form class="layui-form" action="teachersearch.php" method="post" style="">
    <div class="layui-col-md12" style="padding: 15px;border: 1px solid #ccc;">
        <div class="layui-form-item">
            <label class="layui-form-label">Please Input Name:</label>
            <div class="layui-input-block">
                <input type="text" name="keywords" required lay-verify="required" placeholder="Please Input Teacher Name" maxlength="11"
                       autocomplete="off"
                       class="layui-input">
            </div>
        </div>
	...
	$sql="select * from teachers where name like '%".$keywords."%'";
	$state = $pdo->query($sql);
