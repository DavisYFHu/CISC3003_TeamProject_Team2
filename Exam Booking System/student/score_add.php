...
if ($_POST) {
    ...
    $sql = "INSERT INTO score(score,km,sfzh,tel,name,teachers) VALUES ('{$score}','{$km}','{$sfzh}','{$tel}','{$name}','{$teachers}')";

    // Execute sql
    $row = $pdo->exec($sql);
    // Determining Success
    if ($row) {
        echo "<script>alert('Upload successfully!');window.location.href='score.php'</script>";
    } else {
        echo "<script>alert('upload failed!');window.location.href='score_add.php'</script>";
    }
}
?>
<!DOCTYPE html>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div class="layui-container">
            <blockquote class="layui-elem-quote" style="margin-top: 15px;">Upload Scores</blockquote>
            <div class="layui-row">
                <div class="layui-col-md8 layui-col-md-offset1">
                    <form class="layui-form layui-form-pane" action="score_add.php" method="post">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">Scores</label>
                            <div class="layui-input-block">
                                <input type="text" name="score" value="" required autocomplete="off" placeholder="Please input score" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
