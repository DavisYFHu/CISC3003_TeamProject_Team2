...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <div class="layui-container">
        	<blockquote class="layui-elem-quote" style="margin-top: 15px;">My Booking Information</blockquote>
			<table class="layui-table">
			  ...
			  <tbody>
				...
				<?php
				    $uid = $_SESSION['name'];
				    // sql query statement
					$sql = "select * from yuyue where name = '$uid'";
				...
				<tr align="center">
					...
					<td>
						...
						if ($value['status'] == '0') {
							...
							?><span class='test'><a href="#">Go to Exam</a></span><?php
						}
